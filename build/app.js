...
var Cell = React.createClass({displayName: 'Cell',
  ...
  render: function(){
    ...
    return (
      React.createElement("span", {className: className + ' grid-cell', onClick: this.cellClicked})
    )
  }
});
  ...
  render: function(){
    ...
    var grid = this.props.gridData.map(function(row, x){
      var cells = row.map(function(alive, y){
        return (
          React.createElement(Cell, {alive: alive, x: x, y: y, click: click})
        );
      });
      return (
...
},{"./Cell":149,"react":148}],151:[function(require,module,exports){
var React = require('react');
  ...
  render: function(){
    ...
    return(
      React.createElement("div", null, 
        React.createElement(Grid, {gridData: this.state.cells, cellClick: this.cellClick}), 
        React.createElement("div", {className: "controls"}, 
          React.createElement("div", {className: "ui blue button labeled icon", onClick: this.run}, 
            React.createElement("i", {className: icon}), 
            buttonText
          ), 
          React.createElement("div", {className: "ui black button pull-right", onClick: this.clear}, "Clear")
        )
      )
    )
  }
...
},{"./Grid":150,"./conway":153,"react":148}],152:[function(require,module,exports){
var React = require('react');
var Life  = require('./Life');


React.render(
  React.createElement(Life, {height: 51, width: 51}),
  document.getElementById('game')
);

},{"./Life":151,"react":148}],153:[function(require,module,exports){
